<%-- 
    Document   : lessonsManagement
    Created on : Aug 10, 2024, 2:36:28 PM
    Author     : Admin
--%>
    ...
    <div >
        <div class="d-flex mt-3" style="justify-content: space-between">
            <div style="display: flex;
                 ...
                 margin-right: 7%;">
                <a class="btn mt-2" href="<c:url value="/lessonsManagementCreate" />"
                   style="color: #468585;
            ...
            <tbody>
                <c:forEach items="${lessons}" var="c" >
                    <tr id="lesson${c.id}">
                        ...
                        <td>
                            <c:url value="/lessonsManagement/${c.id}" var="u" />
